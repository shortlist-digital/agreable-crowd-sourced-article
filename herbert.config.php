...
return [
     ...
     */
    'routes' => [
        'AgreableSocialArticlePlugin' => __DIR__ . '/app/routes.php'
    ],
     ...
     */
    'panels' => [
        'AgreableSocialArticlePlugin' => __DIR__ . '/app/panels.php'
    ],
     ...
     */
    'apis' => [
        'AgreableSocialArticlePlugin' => __DIR__ . '/app/api.php'
    ],

    /**
     * The view paths to register.
     *
     * E.G: 'AgreableSocialArticlePlugin' => __DIR__ . '/views'
     * can be referenced via @AgreableSocialArticlePlugin/
     * when rendering a view in twig.
     */
    'views' => [
        'AgreableSocialArticlePlugin' => __DIR__ . '/resources/views'
    ],
